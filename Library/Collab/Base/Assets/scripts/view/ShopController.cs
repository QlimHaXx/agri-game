...
public class ShopController : MonoBehaviour {
	...
	void ClickLegume(){
		Description desc = EventSystem.current.currentSelectedGameObject.GetComponent<LegumsMenuController>().Desc;
		descContainer.transform.GetChild(0).GetChild(1).GetComponent<TextMeshProUGUI>().text = desc.TexteDescription;
		descContainer.transform.GetChild(1).GetChild(0).GetComponent<TextMeshProUGUI>().text = EventSystem.current.currentSelectedGameObject.GetComponent<LegumsMenuController>().Nom;
	}
