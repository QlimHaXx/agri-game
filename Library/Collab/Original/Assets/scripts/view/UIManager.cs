...
public class UIManager : MonoBehaviour {
    public Jeu jeu;
    public GameObject shopButton, shopScreen, optionScreen, background, time, date, scoreText, seasonButton, fermier, profilOption, potage;
    ...
    private bool bulleOpened, menuOpened, fermier_ouvert;
    ...
    private void RemplirTemps()
    {
        ...
        DateTime dateBase = DateTime.ParseExact(jeu.Profil.DateSortie, "dd/MM/yyyy", CultureInfo.InvariantCulture);
